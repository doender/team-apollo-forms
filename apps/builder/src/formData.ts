    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          ...
          type: 'formField',
          label:
            'Heeft jouw werkplek een geschikt toetsenbord en muis of trackpad?',
          description:
          ...
          options: [
            {
              ...
              label:
                'Ik gebruik zowel een los toetsenbord als een losse muis of trackpad',
            },
            {
              value: 'onlySepMouse',
            ...
            },
            {
              value: 'laptop',
              label:
                'Ik gebruik het toetsenbord en de trackpad van mijn laptop',
            },
          ],
          validations: [
            {
    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          ...
          type: 'formField',
          label:
            'Wat zou je aan je werkplek willen veranderen wanneer je in de toekomst nog regelmatig thuis zal werken?',
          control: 'textArea',
          validationType: 'string',
          validations: [
            {
    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          ...
          type: 'formField',
          label:
            'Zijn er dingen die je wilt doen om (ergere) klachten te voorkomen?',
          control: 'radioText',
          validationType: 'string',
          options: [
            { value: 'yes', label: 'Ja' },
